...
class MemoListApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(home: MemoList());
  }
}
...
class _MemoListState extends State<MemoList> {
  ...
  void editMemo(String id, String currentName, String currentText) async {
    TextEditingController _editTextCtrl = TextEditingController(
      text: currentText,
    );
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text("수정"),
          content: TextField(controller: _editTextCtrl),
          actions: [
            ElevatedButton(
              onPressed: () async {
              ...
              return ListTile(
                ...
                trailing: Row(
                  ...
                  children: [
                    IconButton(
                      onPressed: () =>
                          editMemo(doc.id, doc["name"], doc["text"]),
